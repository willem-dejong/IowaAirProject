...
function addRow(row){
    ...
    var fjcnum = row.querySelector(".fjcnumCrit").value;
    ...
    if(reoccurrence == "" || model == "" || ecnum == "" || fjcnum == "") {
        flag = true;
        row.bgColor = "#FF0000";
    }
    else{     
        row.bgColor = "transparent";
        var address = "/admin/addPlane?model="+model+"&ecnum="+ecnum+"&fjcnum="+fjcnum+"&reoccurrence="+reoccurrence;
