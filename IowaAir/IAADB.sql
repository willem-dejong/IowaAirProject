...
INSERT INTO `reservations` VALUES (1,'ss','ss','1991-01-01','m',2,89,'ec',1,NULL,NULL),(2,'willem','DeJong','2017-03-08','M',2,48,'ec',2,NULL,NULL),(3,'willem','DeJong','2017-03-08','M',2,60,'ec',2,NULL,NULL),(23,'aa','aa','2017-05-01','M',2,48,'ec',5,NULL,NULL),(24,'aa','aa','2017-05-01','M',2,60,'ec',5,NULL,NULL),(25,'aa','aa','2017-05-01','M',2,66,'ec',5,NULL,NULL),(35,'aa','aa','2017-05-03','M',2,47,'ec',7,NULL,NULL);
...
INSERT INTO `transact` VALUES (1,2),(2,1),(5,1),(7,1);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`localhost` PROCEDURE `cancel`(resID int)
BEGIN
DECLARE oops CONDITION FOR SQLSTATE '45000';
DECLARE EXIT HANDLER FOR SQLEXCEPTION 
    ...
    END;
START TRANSACTION;
set @cls=(select class from iowaair.reservations where res_num=resID limit 1);
if @cls="ec" then
update iowaair.flights set ec_seats_booked=ec_seats_booked-1 where flightID=resID;
else
update iowaair.flights set fc_seats_booked=fc_seats_booked-1 where flightID=resID;
end if;
...
-- Dump completed on 2017-05-03 12:31:10
