function register(){
	if (validateForm()){
		...
		var cmd = "/createuser?fname="+document.getElementById('fnamein').value+"&lname="+document.getElementById('lnamein').value+"&email="+email+"&phone="+document.getElementById('phonein').value;
